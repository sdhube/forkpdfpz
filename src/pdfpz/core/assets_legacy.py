...
class AssetsLegacy(Asset):
    ...
    Constructed with everything needed to load and save it: legacy_path
    (the file), and input_path/books if there's data to save.
    load_assets() reads legacy_path and populates input_path/books from
    the file; save_assets() writes input_path/books to legacy_path.
    ...
    def __init__(self, legacy_path: str = "", input_path: str = "", books=None):
